...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 26, 2022 lúc 08:33 PM
...
INSERT INTO `apply_job` (`id_apply_job`, `id_job`, `id_user`) VALUES
(1, 1, 1),
(2, 1, 2),
(6, 1, 5),
(5, 7, 5),
...
INSERT INTO `job` (`job_id`, `job_desc`, `id_user`, `id_category`, `job_date`, `job_status`, `id_distribution`, `id_working_format`) VALUES
(1, 'MISA tuyển web developer C#, PHP', 1, 1, '0000-00-00 00:00:00', 3, 1, 1),
(3, 'Công ty Danisa tuyển dụng kế toán', 1, 1, '2022-04-17 09:46:12', 1, 1, 2),
(7, 'Tuyển dụng php', 1, 1, '2022-05-01 19:34:54', 3, 1, 1),
(8, 'Tuyển dụng nhận viên bán hàng', 4, 1, '2022-05-02 15:14:21', 3, 2, 1),
(10, 'FPT tuyển dụng nhân viên marketing', 4, 5, '2022-05-22 09:44:46', 3, 2, 1);
